  ...
  return (
    <div  className={`${laBelleAurore}`}>
      <div className="bg-home-hands bg-cover lg:bg-cover bg-no-repeat w-[2400] h-[400px] lg:h-[500px] lg:bg-[center_bottom_-10rem] mb-28 relative">
        <a href="" className={classNames("absolute bg-[#FFBCB2] text-[#FE6A6A] w-80 text-4xl p-3 -translate-x-2/4 -translate-y-2/4 top-2/4 left-2/4", laBelleAurore.className)}>Prothésiste ongulaire</a>
      </div>
      <div className="flex flex-col mb-40">
        ...
        />
        <h2 className={classNames("text-[#FFCECA] text-4xl text-center", laBelleAurore.className)}>House of Ju - Beauté des ongles</h2>
      </div>
      <div className="bg-[#FFF2F0] min-[1148px]:h-[620px] relative flex flex-col min-[1148px]:flex-row justify-center items-center h-auto gap-8 min-[1148px]:gap-8">
        <div className="min-[1148px]:pl-28">
          <Image
            ...
            className={classNames(
              'border-[14px] border-[#FFBCB2] -top-7 w-[650px] h-[800px] min-[1148px]:w-[480px] min-[1148px]:h-[690px] min-[1148px]:absolute',
              'static'
            )}
          />
        </div>
        <div className="flex flex-col items-center gap-10 px-12 py-12 min-[1148px]:pl-[30rem] min-[1148px]:items-baseline">
          ...
          <h3
            className={classNames(
              'text-[#FFA79A] text-3xl font-laBelleAurore'
            )}
          >
            Prothésiste ongulaire à La
            Roche-sur-Foron
          </h3>
          <div className="h-0.5 w-1/4 bg-[#FFBCB2]"></div>
          <p className="text-[#FFA79A]">
            En tant que prothésiste ongulaire,
            j’ai à coeur de prendre soin de vous,
            vos ongles afin de mettre en avant
            votre beauté naturelle. Vernis simple,
            semi-permanent, capsules, gel,
            nail-art… Retrouvez toutes mes
            prestations sur mon site, et venez
            vous faire bichonner dans mon cocon de
            beauté, toujours avec des produits de
            qualité.
          </p>
          <a
            href=""
      ...
      <div className="flex flex-col lg:flex-row justify-around items-center py-24">
        <div className="text-center">
          <h3 className={classNames("text-[#FFA79A] text-4xl p-5 uppercase border-t-2 border-b-2 border-[#FFBCB2] my-5", jim_Nightshade.className)}>Beauté<br/> des ongles</h3>
          <a href="/services" className="text-[#FE6A6A] after:content-['<-'] before:content-['->']"> Découvrir </a>
        </div>
        <Image 
        ...
        />
        <div className="text-center">
          <h3 className={classNames("text-[#FFA79A] text-4xl p-5 uppercase border-t-2 border-b-2 border-[#FFBCB2] my-5", jim_Nightshade.className)}>Beauté<br/> du regard</h3>
          <a href="" className="text-[#FE6A6A] capitalize">à venir</a>
        </div>
      </div>
        ...
        <Image 
          ...
          <div className="flex flex-col lg:flex-row z-10 justify-center gap-32 lg:gap-96 items-center my-auto">
            <div className="bg-white bg-transparent opacity-50">
              <h3 className="uppercase p-24 text-3xl text-[#FE6A6A]">Espace<br/> client</h3>
            </div>
