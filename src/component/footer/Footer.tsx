  ...
  return (
    <footer>
      <div className='flex flex-col items-center gap-4 text-center bg-[#FFF2F0] py-10'>
        ...
        />
        <h3
          className={classNames('text-[#FE6A6A] text-3xl font-laBelleAurore')}
        >
          Prothésiste Ongulaire
        </h3>
        <h2 className='text-[#FFA79A] uppercase font-jimNightshade text-2xl'>
          Julia Santin
        </h2>
        ...
        <p className='text-[#FFA79A] font-labelleaurore'>
        ...
        <div className='flex text-2xl gap-2 mb-4 text-[#FE6A6A]'>
          <a target='blank' href='https://www.instagram.com/houseofju22/'>
            <FaInstagram />
          </a>{' '}
          <a target='blank' href='https://www.facebook.com/julia.dijoux.507'>
            <FaFacebook />
          </a>
        </div>
      </div>
      <div className='bg-[#FFBCB2] text-[#781b1b] font-jimNightshade uppercase text-xl flex flex-col justify-center items-center gap-3 py-5'>
        ...
        <p>
          ...
          <a
            ...
            target='blank'
            className='pl-6 text-[#FE6A6A] text-3xl font-bold capitalize font-laBelleAurore'
          >
            Laura Santin
          </a>{' '}
        </p>
