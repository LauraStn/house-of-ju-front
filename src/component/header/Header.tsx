...
const Header = (props: {userLogged: User}) => {
  ...
  return (
    <div className='sticky top-0 z-40'>
      <div className='bg-bittersweet text-center text-sm md:text-base text-persian-plum'>
      ...
      <header
        className={classNames(
          'sticky md:static transition-all h-24 left-0 right-0 duration-500 bg-melon text-white  md:px-4 md:py-2 flex  md:flex-row '
        )}
      >
        <Image
