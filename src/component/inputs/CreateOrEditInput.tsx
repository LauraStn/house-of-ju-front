  ...
  return (
    <div className='flex flex-col'>
      ...
      <input
        ...
        className='focus:outline-none p-2 focus:border-mona-lisa focus:ring-1 focus:ring-mona-lisa border-solid border-2 border-chardon rounded-md h-8 w-72 md:w-96'
